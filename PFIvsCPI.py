...
cor_mat[0:(p-1),0]=intra_cor
cor_mat[0,0:(p-1)]=intra_cor
...
# %%
inter=[100,200, 350, 500, 750, 1000, 2000, 3500, 5000, 7500, 10000]
...
n=1000
x = norm.rvs(size=(p, n), random_state=seed)
noise_arr=[0, 0.1, 0.3, 0.5, 0.75, 1, 1.5, 2,3.5, 5, 10]
